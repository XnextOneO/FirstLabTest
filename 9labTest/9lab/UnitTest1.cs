...
namespace FunctionalTests
{
    public class Tests
    {
        ...
        public void MyTest()
        {
            ...
            driver.FindElement(By.XPath("/html/body/div[2]/div[1]/div/div/div/nav[2]/ul/li[8]/a")).Click();
            driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(5);
            driver.FindElement(By.XPath("/html/body/div[2]/div[5]/div/div/div/div/div/ul/li[2]/a")).Click();
            driver.Close();
        }
